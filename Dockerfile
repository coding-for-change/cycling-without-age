...
ARG NEXT_PUBLIC_TRANSLATOR_MODE=""
ARG NEXT_PUBLIC_TOLGEE_PROJECT_ID=""
ARG SENTRY_ORG=""
ARG SENTRY_PROJECT=""
...
ENV NEXT_PUBLIC_TRANSLATOR_MODE=$NEXT_PUBLIC_TRANSLATOR_MODE
ENV NEXT_PUBLIC_TOLGEE_PROJECT_ID=$NEXT_PUBLIC_TOLGEE_PROJECT_ID
