  ...
  member: {
    ...
    pages: {
      ...
      chat: {
        title: "Nachrichten",
        pilot: {
          body: "Bisher ist es still. Sobald der Chat offen ist, hörst du hier von deiner Captain und den anderen Piloten — wer am Samstag fährt, wer eine Vertretung braucht.",
        },
        passenger: {
          body: "Bisher ist es still. Wenn die Nachrichten starten, sagt Ihre Ortsgruppe hier Hallo — und Sie können um eine extra Decke bitten, wenn es kalt ist.",
        },
      },
    },
  },
